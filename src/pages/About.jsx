    ...
    <>
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-white via-slate-50 to-white py-20 px-6">
        ...
        >
          ...
          {[
            `Ang mga digital poster ay kilala rin bilang mga digital signage screen o digital display. Ginagamit ang mga ito upang biswal na ipakita ang impormasyon o mga mensahe na nais ipabatid sa mga kuwento. Ang mga digital na poster na ito ay namumukod-tangi para sa kakayahang makaakit sa pamamagitan ng dinamikong nilalaman, isang tampok na hindi maaaring tumugma sa mga tradisyunal na poster. Hindi tulad ng mga statik na imahen, ang mga digital na poster na ito ay isang interaktibo na elemento para pamukaw interes sa mga mag-aaral. Ang mga mananaliksik ang gumamit ng isang AI tools upang makabuo o makalikha ng isang digital poster na naayon sa mga likhang kuwento na ginawa para sa pag-aaral. Ginamit ang AI upang makabuo ng isang malinaw, at malikhain sa biswal na presentasyon na makatutulong upang maging mas madali ang pag-unawa ng mga mag-aaral maging ang mga guro. Sa tulong ng AI digital poster, ang mga kuwento ay naipapakita ng mas malinaw, ito rin ay nagsisilbing isang pantulong na kagamitang pampagtuturo upang ang mga mag-aaral ay maging mas aktibo, interesado, at malinaw ang pagkakaunawa tungkol sa mga kuwento.`,
          ].map((text, i) => (
            <motion.p
              key={i}
              variants={fadeInUp}
